...
/**
 * Public tests for Worksheet 4, Exercise 3. Four tests with three different URLs. I shows also
...
public class WebCrawlerTest {
	...
	assertEquals("The list of URLs returned is incorrect.", expected, actual);
}
...
@Test
public void ex3PublicTest4(){
	url = "https://www.cs.bham.ac.uk/~pxc/";
	
	ArrayList<String> expected = new ArrayList<>(Arrays.asList(
			"mailto:s.laflin@cs.bham.ac.uk",
			"farewell/FarewellSue.htm",
			"student-projects.html",
			"teaching.html",
			"research.html",
			"http://www.susan-laflin.me.uk"));
	ArrayList<String> actual = WebCrawler.collectURLs("https://www.cs.bham.ac.uk/~slb/");
